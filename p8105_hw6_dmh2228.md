...
One using mother’s age at delivery (in years) and average number of
cigarettes smoked per day during pregnancy as predictors (main effects
only). This model is based on factors that underly birthweight.
...
```
    ...
    ## 2 momage         18.8       1.98      9.47 4.50e-21
    ## 3 smoken         -5.97      1.04     -5.75 9.68e- 9
